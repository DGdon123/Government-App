...
class Karyalaya extends StatefulWidget {
  const Karyalaya({Key? key}) : super(key: key);

  @override
  State<Karyalaya> createState() => _KaryalayaState();
}

class _KaryalayaState extends State<Karyalaya> {
  int currentIndex = 0;
