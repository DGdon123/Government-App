...
class Indhan extends StatefulWidget {
  const Indhan({Key? key}) : super(key: key);

  @override
  _IndhanState createState() => _IndhanState();
}

class _IndhanState extends State<Indhan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("इन्धनको प्रार्थना",
            style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'इन्धनको प्रार्थनाको आधारमा घरपरिवार',
