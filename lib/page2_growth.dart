...
class PGrowth extends StatefulWidget {
  const PGrowth({Key? key}) : super(key: key);

  @override
  State<PGrowth> createState() => _PGrowthState();
}

class _PGrowthState extends State<PGrowth> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("स्थानीय उत्पादन",
            style: TextStyle(
              color: Color(0xFFFFFFFF),
